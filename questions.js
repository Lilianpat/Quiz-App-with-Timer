let questions = [
  ...
  {
    numb: 7,
    question: "What attribute is used to specify the URL of an image in the <img> tag?",
    answer: "src",
    options: [
      "href",
      "src",
...

  {
    ...
    answer: "Logs a message to the console",
    options: [
      "Displays a message on the screen",
      "Logs a message to the console",
      "Creates a pop-up alert",
      "Writes text to the HTML document"
    ]
  },
...

  {
    ...
    answer: "To position an element to the left or right of its container",
    options: [
...

  {
    ...
    answer: "The title of the page shown in the browser tab",
    options: [
